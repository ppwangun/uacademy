...
class Contract extends \Application\Entity\Contract implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Contract' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Contract' . "\0" . 'refNumber', '' . "\0" . 'Application\\Entity\\Contract' . "\0" . 'status', '' . "\0" . 'Application\\Entity\\Contract' . "\0" . 'volumeHrs', '' . "\0" . 'Application\\Entity\\Contract' . "\0" . 'amount', '' . "\0" . 'Application\\Entity\\Contract' . "\0" . 'academicYear', '' . "\0" . 'Application\\Entity\\Contract' . "\0" . 'teacher'];
        }
