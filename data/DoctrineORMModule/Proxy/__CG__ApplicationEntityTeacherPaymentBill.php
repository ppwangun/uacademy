...
class TeacherPaymentBill extends \Application\Entity\TeacherPaymentBill implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\TeacherPaymentBill' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\TeacherPaymentBill' . "\0" . 'refNumber', '' . "\0" . 'Application\\Entity\\TeacherPaymentBill' . "\0" . 'date', '' . "\0" . 'Application\\Entity\\TeacherPaymentBill' . "\0" . 'paymentAmount', '' . "\0" . 'Application\\Entity\\TeacherPaymentBill' . "\0" . 'paymentStatus', '' . "\0" . 'Application\\Entity\\TeacherPaymentBill' . "\0" . 'totalTime', '' . "\0" . 'Application\\Entity\\TeacherPaymentBill' . "\0" . 'contract', '' . "\0" . 'Application\\Entity\\TeacherPaymentBill' . "\0" . 'teacher'];
        }
