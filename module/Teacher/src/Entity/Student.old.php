...
class Student
{
     ...
     * @var string
     *
     * @ORM\Column(name="tutor_profession", type="string", length=255, nullable=true)
     */
    private $tutorProfession;

    /**
     * @var string
     *
     * @ORM\Column(name="tutor_phone_number", type="string", length=255, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="tutor_email", type="string", length=255, nullable=true)
     */
    private $tutorEmail;
     ...
     * @var string
     *
     * @ORM\Column(name="tutor_country", type="string", length=255, nullable=true)
     */
    private $tutorCountry;

    /**
     * @var string
     *
     * @ORM\Column(name="tutor_city", type="string", length=255, nullable=true)
     */
    private $tutorCity;
     ...
     * Set tutorProfession
     *
     * @param string $tutorProfession
     *
     * @return Student
     */
    public function setTutorProfession($tutorProfession)
    {
     ...
     * @return string
     */
    public function getTutorProfession()
    {
        return $this->tutorProfession;
    }

    /**
     * Set tutorPhoneNumber
     *
     * @param string $tutorPhoneNumber
     *
     * @return Student
     */
     ...
     * Set tutorCountry
     *
     * @param string $tutorCountry
     *
     * @return Student
     */
    public function setTutorCountry($tutorCountry)
    {
     ...
     * @return string
     */
    public function getTutorCountry()
    {
        return $this->tutorCountry;
    }

    /**
     * Set tutorCity
     *
     * @param string $tutorCity
     *
     * @return Student
     */
    public function setTutorCity($tutorCity)
    {
